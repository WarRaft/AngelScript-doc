...
Стандартные типы [](handle.md) были расширены, чтоб привнести больше возможностей для манипулирования данными игры.
...
Все типы [](handle.md) представлены в игре как `uint`, который можно преобразовать в тип для дальнейшего использования в
коде.
